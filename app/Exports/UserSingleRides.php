...
class UserSingleRides implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents
{
    /**
    ...
    public function collection()
    {
        $single_rides = (new UserRide())
            ...
            ->select(
                ...
                'user_rides.source', 'user_rides.destination',
                DB::raw('(CASE WHEN user_rides.status = 1 
