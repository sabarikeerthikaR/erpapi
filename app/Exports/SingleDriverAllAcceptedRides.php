...
class SingleDriverAllAcceptedRides implements FromCollection,WithHeadings, ShouldAutoSize, WithEvents
{
    protected $driver_id;
    ...
    */
    public function collection()
    {
        $accepted_rides = UserRide::with(['rateReview' => function ($query) {
            ...
            ->where('user_rides.driver_id', '=', $this->driver_id)->orderBy('created_at', 'desc')
