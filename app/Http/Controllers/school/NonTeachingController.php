...
public function show(request $request)
   ...
   public function index(request $request)
    {
        $Staff = Staff::where('employee_id',$request->employee_id)->where('employee_type','=',2)
        ...
        'additional','employee_id','passport_photo','credential_certificate','national_id_copy','tsc_letter','disable')
        ->first();
             if(!empty($Staff)){
                    return response()->json([
                    'data'  => $Staff      
...
public function destroy(Request $request)
    ...
    public function disable(request $request)
   {
       ...
       $staff = Staff::where('employee_id',$request->employee_id)->where('staff.employee_type','=',2)->first();
       $staff->disable= 1;
       if($staff->save()){
           return response()->json([
   ...
   public function inactive()
   {
       ...
       ->where('disable','=',1)->where('staff.employee_type','=',2)->get();
